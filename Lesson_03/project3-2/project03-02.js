...
for (let i = 0; i < captions.length; i++) {
      ...
      // open img tag, add alt text from caption array, and src image path from counter
      htmlCode += "<img alt='" + captions[i] + "' src='slide" + i + ".jpg' />";

      // open figcaption tag and add caption text
